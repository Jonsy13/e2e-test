...
describe(["teaming"], "Testing the Teaming section", () => {
  ...
  it(["teaming"], "Test case to check the default Project Details of Teaming Tab", () => {
...
describe(["teaming"], "Test case to check the Invitation Functionality (Invitation as a Viewer)", () => {
...
describe(["teaming"], "Test case to check the Invitation Functionality (Invitation as an Editor)", () => {
  before("Clearing local storage & login as Admin", () => {
    cy.clearCookie("litmus-cc-token");
    indexedDB.deleteDatabase("localforage");
    cy.requestLogin(AdminName, AdminPassword);
...
describe(["teaming"], "Testing the functionality of removing user from project", () => {
  before("Clearing local storage & login as Admin", () => {
    cy.clearCookie("litmus-cc-token");
    indexedDB.deleteDatabase("localforage");
    cy.requestLogin(AdminName, AdminPassword);
...
describe(["teaming"], "Testing the functionality of leaving from project", () => {
...
describe(["teaming"], "Testing the functionality of resending invitation to exited user2", () => {
  before("Clearing local storage & login as admin", () => {
    cy.clearCookie("litmus-cc-token");
    indexedDB.deleteDatabase("localforage");
    cy.requestLogin(AdminName, AdminPassword);
