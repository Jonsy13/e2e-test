...
cd .. && docker run -it -v $PWD/Cypress:/e2e -w /e2e -e CYPRESS_BASE_URL=${AccessURL} -e CYPRESS_INCLUDE_TAGS="login" cypress/included:7.3.0 --config-file cypress.prod.json
