...
cd .. && docker run -it -v $PWD/Cypress:/e2e -w /e2e cypress/included:7.3.0 --config-file cypress.prod.json -env CYPRESS_BASE_URL=${AccessURL},CYPRESS_INCLUDE_TAGS="login"
